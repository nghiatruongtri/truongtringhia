...
import Task from "../models/task.model"; // Assuming you have defined ITask interface in task.model.ts
...
router.delete("/tasks/:id", auth, async ({params, user}: Request, res: Response) => {
    try {
